...
export type DocumentRow={id:string;type:string;code:string|null;title:string;description:string|null;assignee_name:string|null;assignee_id:string|null;document_year:number|null;status:DocumentStatus;created_by:string;created_at:string;updated_at:string;deleted_at?:string|null;deleted_by?:string|null;is_checked?:boolean|null;checked_by?:string|null;checked_at?:string|null;is_signed?:boolean|null;signed_by?:string|null;signed_at?:string|null}
...
export type NotificationRow={id:string;type:string;title:string;message:string;data:Record<string,unknown>;created_at:string;is_read?:boolean}
